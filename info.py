...
UPDATES = environ.get('UPDATES', 'FilmokamellaX')
MY_CHATS = environ.get('MY_CHATS', '-1001114885212')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'iFilms_Support')
...
LOGGING = str(environ.get("LOGGING", "True"))
